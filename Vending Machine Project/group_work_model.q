...
*/
(Dispensing.Dispense_Product and selected_product == 1 and Inventory_Management.coke_quantity == 10) --> \
((Dispensing.Success and Inventory_Management.coke_quantity == 9) \
or \
(Dispensing.Error and Inventory_Management.coke_quantity == 10))

/*

*/
(Dispensing.Dispense_Product and selected_product == 2 and Inventory_Management.chips_quantity == 10) --> \
((Dispensing.Success and Inventory_Management.chips_quantity == 9) \
or \
(Dispensing.Error and Inventory_Management.chips_quantity == 10))
...
*/
E<> Dispensing.Success and selected_product == 1 and Inventory_Management.coke_quantity < 10

/*

*/
E<> Dispensing.Success and selected_product == 2 and Inventory_Management.chips_quantity < 10
